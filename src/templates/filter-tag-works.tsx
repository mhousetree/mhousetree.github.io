...
const FilterCategoryTemplate: React.FC<
  PageProps<Queries.FilterCategoryTemplateQuery, TagPageContext>
> = ({ data, pageContext }) => {
  console.log(data)
  console.log(pageContext.tagInfo)
    ...
    <Layout>
      <GridMain>
        <Header>
          ...
          <h1>Tag: {pageContext.tagInfo.name}</h1>
        </Header>
        <MainContent>
          <h1>
            Works
            <br />- {pageContext.tagInfo.name}
          </h1>
          <WorksWrapper>
